...
# 程序输出
"""
请输入精确到小数点后多少位，用空格分隔（例如 100 1000 10000）: 1000 10000 100000
计算 1000 项圆周率耗时: 0.00013990001752972603 秒，圆周率值: 3.140592653839794
计算 10000 项圆周率耗时: 0.0015619999903719872 秒，圆周率值: 3.1414926535900345
计算 100000 项圆周率耗时: 0.017679600015981123 秒，圆周率值: 3.1415826535897198
程序运行时间：0.31198900000890717 秒
所有进程总耗时: 0.019381500023882836 秒
"""
